...
REVOKE ALL ON FUNCTION public.get_weekly_leaderboard(timestamptz) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.get_weekly_leaderboard(timestamptz) TO authenticated;
