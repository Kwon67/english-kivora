...
export const primaryBtn =
  'inline-flex items-center justify-center gap-2 overflow-hidden rounded-full bg-primary px-5 py-3 font-montserrat text-sm font-bold text-on-primary shadow-[0_10px_22px_rgba(24,59,22,0.22)] transition-colors hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary/40 disabled:cursor-not-allowed disabled:opacity-60'

export const primaryBtnLg =
  'inline-flex items-center justify-center gap-2 overflow-hidden rounded-full bg-primary px-8 py-4 text-base font-bold text-on-primary shadow-[0_16px_34px_rgba(24,59,22,0.22)] transition-colors hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary/40 disabled:cursor-not-allowed disabled:opacity-50'
...
export const authInput =
  'Input self-stretch py-3 bg-surface/50 rounded-xl border border-dashed border-border-muted/24 inline-flex justify-center items-start overflow-hidden w-full transition-all focus-within:border-solid focus-within:border-primary focus-within:shadow-[0_0_14px_rgba(24,59,22,0.12)] focus-within:bg-card/90 dark:bg-primary/8 dark:border-border-accent/24 dark:focus-within:border-solid dark:focus-within:border-primary dark:focus-within:bg-surface-container-lowest/90 dark:focus-within:shadow-[0_0_14px_rgba(184,255,92,0.12)]'

export const authSubmitBtn =
  'inline-flex w-full cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-full bg-primary py-3.5 font-montserrat text-lg font-bold leading-7 text-on-primary border border-dashed border-primary-container/50 shadow-[0px_8px_15px_0px_rgba(24,59,22,0.15)] transition-colors hover:bg-primary-dark dark:border-primary/25 focus:outline-none focus:ring-2 focus:ring-primary/40 disabled:cursor-not-allowed disabled:opacity-50'
