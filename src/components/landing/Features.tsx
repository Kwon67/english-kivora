        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature) => {
            ...
            return (
              <article
                key={feature.title}
                className="scroll-reveal rounded-[20px] border border-dashed border-border-muted/22 bg-[#F4F1EA] p-6 shadow-[0_12px_34px_rgba(28, 25, 21,0.10)] transition-transform hover:-translate-y-1 hover:shadow-[0_18px_42px_rgba(28, 25, 21,0.13)] dark:border-border-accent/20 dark:bg-card dark:shadow-[0_16px_38px_rgba(0,0,0,0.42)]"
              >
