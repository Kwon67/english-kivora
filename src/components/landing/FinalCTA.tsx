    ...
    <section className="border-t border-border-muted/14 bg-transparent py-24 dark:border-border-accent/16 dark:bg-transparent">
      <div className="mx-auto max-w-2xl px-4 text-center sm:px-6">
        ...
        <div className="mt-8 flex justify-center">
          <Link
            href="/register"
            className="inline-flex items-center justify-center rounded-full bg-primary px-8 py-4 text-base font-bold text-on-primary shadow-[0_16px_34px_rgba(24,59,22,0.22)] transition-colors hover:bg-primary-dark"
          >
