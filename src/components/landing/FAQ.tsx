      ...
      <div className="mx-auto grid w-full max-w-[var(--page-width)] gap-10 px-4 sm:px-6 lg:grid-cols-[0.75fr_1.25fr] lg:px-8">
        ...
        <div className="space-y-3">
          {questions.map((item) => (
            <details
              key={item.question}
              className="group rounded-[18px] border border-border-muted/18 bg-[#f7f8ef] px-5 py-4 shadow-[0_8px_24px_rgba(31,43,18,0.07)] dark:border-border-accent/18 dark:bg-card dark:shadow-[0_12px_28px_rgba(0,0,0,0.3)]"
            >
