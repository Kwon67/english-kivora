      ...
      <div className="mx-auto w-full max-w-[var(--page-width)] px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-4 lg:grid-cols-3">
          {practiceFlows.map((flow, index) => {
            ...
            return (
              <article key={flow.title} className="flex min-h-full flex-col rounded-[20px] border border-dashed border-border-muted/22 bg-[#f7f8ef] p-6 shadow-[0_12px_34px_rgba(31,43,18,0.10)] dark:border-border-accent/20 dark:bg-card dark:shadow-[0_16px_38px_rgba(0,0,0,0.42)]">
