...
import { Home, BarChart3, LayoutDashboard, Package, UserCheck, LogOut } from 'lucide-react'
    ...
    <nav className="sticky top-0 z-50 border-b border-[var(--color-border)] bg-white/80 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-5xl items-center justify-between px-4">
        ...
        <Link
          ...
          className="flex items-center gap-2.5 font-bold tracking-tight text-lg text-[var(--color-primary)] cursor-pointer"
        >
        ...
        <div className="flex items-center gap-3">
          ...
          <form action={logoutAction}>
            <button
              type="submit"
              className="flex items-center gap-1.5 rounded-lg border border-[var(--color-border)] px-3 py-1.5 text-xs font-medium text-[var(--color-text-muted)] transition-colors hover:bg-red-50 hover:text-[var(--color-error)] hover:border-red-200 cursor-pointer"
            >
