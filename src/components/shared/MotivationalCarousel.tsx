...
const SLIDES: Slide[] = [
  {
    ...
    note: 'Treino diário fica mais leve quando a interface te guia com clareza e ritmo.',
    palette: 'teal',
    artwork: 'voice',
  },
  {
  ...
  },
  {
    ...
    note: 'Constância vence intensidade isolada. O produto precisa te convidar a voltar todos os dias.',
    palette: 'orange',
    artwork: 'momentum',
  },
]
