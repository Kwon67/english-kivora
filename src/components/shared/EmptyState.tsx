...
const containerClasses: Record<EmptyStateVariant, string> = {
  ...
  compact: 'rounded-[1rem] bg-[var(--color-surface-container-low)] p-6 text-center',
  arena:
    'rounded-[1.2rem] border border-amber-500/20 bg-[linear-gradient(135deg,rgba(255,251,235,0.76),rgba(245,158,11,0.08))] p-6 text-center',
}
