...
function FormSectionSkeleton() {
  return (
    <div className={`${adminAssignPanel} animate-pulse space-y-4`}>
      <div className="rounded-control border border-brand-dark/15 bg-bg-primary p-4">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-[1fr_1fr_auto]">
          <div className="h-12 rounded-control border border-brand-dark/15 bg-bg-card" />
          <div className="h-12 rounded-control border border-brand-dark/15 bg-bg-card" />
          <div className="h-12 rounded-control border border-brand-dark/15 bg-bg-card" />
        </div>
      </div>
      <div className="grid gap-3 sm:grid-cols-2">
        <div className="h-12 rounded-control border border-brand-dark/15 bg-bg-primary" />
        <div className="h-12 rounded-control border border-brand-dark/15 bg-bg-primary" />
      </div>
      <div className="grid gap-3 sm:grid-cols-3 lg:grid-cols-6">
        {Array.from({ length: 6 }).map((_, index) => (
          <div key={index} className="h-24 rounded-control border border-brand-dark/15 bg-bg-primary" />
        ))}
      </div>
      <div className="h-12 rounded-control border border-brand-dark/15 bg-bg-primary" />
    </div>
  ...
  return (
    <div className={`${adminAssignPanel} animate-pulse`}>
      ...
      <div className="mt-4 grid gap-4 xl:grid-cols-2">
        <div className="h-72 rounded-control border border-brand-dark/15 bg-bg-primary" />
        ...
        <div className={adminAssignPanel}>
          ...
          <div className="mt-4 space-y-3">
            {Array.from({ length: 2 }).map((_, index) => (
              <div key={index} className="h-20 rounded-control border border-brand-dark/15 bg-bg-primary" />
            ))}
          </div>
        </div>
