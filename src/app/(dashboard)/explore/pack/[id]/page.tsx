...
const primaryBtn =
  'inline-flex items-center justify-center gap-2 rounded-xl bg-[#183b16] dark:bg-[#b8ff5c] w-full py-4 text-base font-bold text-[#f7f8ef] dark:text-[#050704] border border-dashed border-[#e3ecc2]/50 dark:border-[#1d2b14]/50 shadow-[0px_8px_15px_0px_rgba(24,59,22,0.15)] transition-all hover:bg-[#24551d] dark:hover:bg-[#cbff83] active:scale-[0.985]'
const backLink =
...
const iconContainer =
  'flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#e3ecc2] text-[#183b16] dark:bg-[#1d2b14] dark:text-[#b8ff5c]'
