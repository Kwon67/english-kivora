...
export default async function PackDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="home-mobile-optimized explorar-root relative -mx-4 -my-6 overflow-hidden bg-surface px-4 py-6 pb-8 text-text sm:-mx-6 sm:-my-8 sm:px-6 sm:py-8 dark:bg-[#0a0a0a] dark:text-text">
