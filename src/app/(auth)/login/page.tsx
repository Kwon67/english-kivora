      ...
      <section className="relative flex flex-1 flex-col justify-between overflow-hidden bg-[linear-gradient(180deg,#5e7a71_0%,#466259_100%)] px-6 py-8 text-white sm:px-8 md:w-1/2 md:px-12 md:py-12">
        ...
        <div className="relative z-10 mt-16 max-w-lg md:mt-0">
          <h1 className="text-responsive-lg max-w-md text-white">
            Master English. Elevate Your World.
          </h1>
          <p className="mt-5 max-w-md text-lg leading-relaxed text-white/82">
            Enter a space designed for focused learning, professional growth and academic excellence.
          </p>
        </div>
      </section>
      ...
      <section className="-mt-6 flex flex-1 items-center justify-center rounded-t-[2rem] bg-[var(--color-surface)] px-6 py-8 sm:px-8 md:mt-0 md:rounded-l-[2rem] md:rounded-tr-none md:px-12">
        <div className="w-full max-w-md">
          <div className="space-y-2">
            <h2 className="text-4xl font-bold text-[var(--color-text)]">Welcome back</h2>
