...
export default function LoginPage() {
  return (
    <div className="relative flex min-h-screen w-full items-stretch justify-center overflow-y-auto bg-zinc-50 py-4 text-start text-base font-normal leading-6 text-text select-none sm:py-6 md:items-center md:p-8">
      ...
      <div
        ...
        style={{
          ...
          <div className="md:hidden flex h-[150px] w-full items-end justify-center overflow-hidden border-b border-zinc-200/40 bg-gradient-to-b from-emerald-50/20 to-transparent object-contain object-bottom py-0">
            <div className="relative -ml-5 h-[150px] w-[384px] origin-bottom scale-[0.45] object-contain object-bottom">
              <LoginIllustration />
            </div>
          </div>
          ...
          <div className="flex w-full shrink-0 flex-col justify-between p-0 md:w-[460px] md:p-8">
