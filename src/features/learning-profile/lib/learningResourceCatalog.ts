...
export const LEARNING_RESOURCE_CATALOG: LearningResource[] = [
  ...
  {
    id: 'c1-personal-practice',
    title: 'Precisão e registro C1',
    description: 'Pratique colocações, nuances e reformulação nas atividades do seu plano.',
    actionLabel: 'Abrir rotina',
    href: '/study',
    level: 'C1',
    kind: 'reading',
    interests: ['work', 'exam', 'grammar'],
    priority: 95,
  },
  {
    id: 'c1-dialogue',
    title: 'Argumentação em conversa',
    description: 'Use o tutor para desenvolver respostas próprias e esclarecer ideias em inglês.',
  ...
  {
    id: 'c2-personal-practice',
    title: 'Nuances e precisão C2',
    description: 'Trabalhe sentido implícito e vocabulário contextual nas atividades do seu plano.',
    actionLabel: 'Abrir rotina',
    href: '/study',
    level: 'C2',
    kind: 'reading',
  ...
  {
    id: 'c2-dialogue',
    title: 'Comunicação flexível',
    description: 'Pratique respostas espontâneas com o tutor e reformule ideias para ganhar clareza.',
    actionLabel: 'Abrir tutor',
    href: '/tutor',
    level: 'C2',
    kind: 'listening',
