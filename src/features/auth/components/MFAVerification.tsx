        ...
        <div className="flex w-full flex-col items-start justify-start gap-2">
          ...
          >
            <input
              ...
              className="w-full border-none bg-transparent p-0 text-center font-mono text-2xl font-semibold tracking-[0.42em] text-[var(--color-text)] outline-none focus:outline-none focus:ring-0"
              required
              autoFocus
            />
          </div>
