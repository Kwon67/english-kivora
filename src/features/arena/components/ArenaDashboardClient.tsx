  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap items-center gap-2">
        <div className="stitch-pill bg-[var(--color-surface-container-low)] text-text-muted">
        ...
        {onlineProfiles.slice(0, 6).map((profile) => (
          <div
            key={profile.id}
            className="inline-flex items-center gap-2 rounded-full bg-[var(--color-surface-container-low)] px-3 py-2 text-xs font-semibold text-text-muted shadow-[var(--shadow-sm)]"
          >
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-semibold text-text">Configurar duelo</h2>
            ...
            <div className="stitch-panel bg-[var(--color-surface-container-low)] p-6">
              <div className="grid gap-4 md:grid-cols-[1fr_auto_1fr] md:items-center">
                <div className="text-center">
                  <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-[1.1rem] bg-[var(--color-surface-container-low)] text-lg font-bold text-primary shadow-[var(--shadow-sm)]">
                    {selectedPlayer1Name?.slice(0, 1).toUpperCase()}
                  </div>
                  <p className="mt-3 text-sm font-semibold text-text">{selectedPlayer1Name}</p>
                </div>

                <div className="flex flex-col items-center gap-2">
                  <div className="rounded-full bg-primary px-4 py-1.5 text-[10px] font-bold uppercase tracking-[0.18em] text-on-primary">
                    VS
                  </div>
                  <div className="text-center text-xs text-text-subtle">
                    {selectedPackName}
                    <div className="mt-1 font-semibold text-primary">{selectedGame?.name}</div>
                  </div>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="mt-3 text-sm font-semibold text-text">{selectedPlayer2Name}</p>
                </div>
              </div>

              <div className="mt-5 flex items-start gap-3 rounded-[1rem] bg-[var(--color-surface-container-low)]/80 px-4 py-4 text-sm text-text-muted">
        ...
        >
          ...
          <div className="flex flex-col gap-4">
            {activeDuels.map((duel) => {
              ...
              return (
                <div key={duel.id} className="flex items-center justify-between rounded-xl border border-[var(--color-surface-container-highest)] bg-surface-container-lowest p-4 shadow-sm">
                  <div>
                    <div className="font-semibold text-text">
                      {p1} <span className="text-primary mx-1 text-xs">VS</span> {p2}
                    </div>
