...
export const accentBadge = `inline-flex items-center rounded-full border border-brand-dark bg-brand-accent px-2.5 py-1 font-heading text-[10px] font-bold uppercase tracking-widest text-brand-dark`
...
export const modeToggleWrap = `flex w-full gap-1 ${landingRadius} border border-brand-dark bg-bg-primary p-1 sm:max-w-sm`
