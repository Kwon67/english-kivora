...
export const glassTile =
  'home-glass-tile render-contained relative overflow-hidden rounded-[20px] border border-dashed border-border-muted/22 bg-surface-container-lowest shadow-[0_12px_34px_rgba(28, 25, 21,0.10)]'
