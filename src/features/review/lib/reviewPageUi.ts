...
export const reviewFrostedSurface = 'home-frosted-surface home-frosted-surface-soft'
export const reviewFrostedSubtle = 'home-frosted-subtle'
export const reviewFrostedAccent = 'home-frosted-subtle review-frosted-accent'

export const reviewShell = `${homeShellClass} review-retention-lab min-h-[calc(100vh-5rem)] min-h-[calc(100svh-5rem)] pb-20 sm:pb-10`

export const reviewHero = `${landingHeroCardClass} ${reviewFrostedSurface} relative overflow-hidden`

export const reviewPanel = `${homeCardClass} ${reviewFrostedSurface} p-4 sm:p-5`
export const reviewPracticePanel = `${homeCardClass} ${reviewFrostedSurface} relative overflow-hidden p-3 sm:p-5 lg:p-6`

export const reviewTile = `${homeNestedCardClass} ${reviewFrostedSubtle}`
...
export const reviewRetentionStrip = `flex w-full min-w-0 flex-col gap-2.5 overflow-hidden md:flex-row md:items-center md:justify-between ${landingRadiusLg} ${reviewFrostedSubtle} border border-brand-dark px-4 py-3 md:gap-4`
...
export const reviewTelemetryBand = `grid grid-cols-3 gap-1.5 sm:gap-2 lg:grid-cols-6 ${landingRadiusLg} ${reviewFrostedSurface} border border-brand-dark p-2 sm:gap-3 sm:p-3`

export const reviewTelemetryCell = `flex min-w-0 flex-col gap-0.5 ${landingRadiusLg} ${reviewFrostedSubtle} border border-brand-dark/25 px-2 py-2 sm:px-3 sm:py-2.5 md:px-4 md:py-3`
...
export const reviewMobileSwipeHint = `lg:hidden ${landingRadiusLg} ${reviewFrostedSubtle} border border-brand-dark/25 px-3 py-2 text-center font-body text-[11px] font-semibold leading-snug text-brand-secondary`
...
export const reviewSessionBanner = `${landingRadiusLg} ${reviewFrostedSubtle} border border-brand-dark px-4 py-3`
...
export const reviewStatRow = `flex items-center justify-between rounded-container ${reviewFrostedSubtle} border border-brand-dark/25 px-4 py-3`

export const reviewStatRowAccent = `flex items-center justify-between rounded-container ${reviewFrostedAccent} border border-brand-dark px-4 py-3`
...
export const reviewMeaningCard = `mx-auto w-full max-w-xl select-text rounded-container ${reviewFrostedSubtle} border border-brand-dark px-4 py-3 text-left sm:px-6 sm:py-4`
