...
export default function TutorHeader() {
  ...
  return (
    <div className="relative rounded-[22px]">
      <header className="home-glass-panel render-contained group relative isolate overflow-hidden rounded-[22px] border border-[#172113]/20 bg-[#fbfcf2] px-6 py-6 shadow-[0_18px_48px_rgba(31,43,18,0.14)] transition-colors duration-300 sm:px-8 sm:py-8 lg:py-8 dark:border-[#d5e6a9]/20 dark:bg-[#11160e] dark:shadow-[0_20px_54px_rgba(0,0,0,0.5)]">
      {/* Background sheen */}
      ...
      <div className="relative z-10 grid gap-6 lg:grid-cols-[1.35fr_0.65fr] lg:items-center">
        <div>
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-3">
            <m.div 
              whileHover={{ y: -4 }}
              className="overflow-hidden rounded-[20px] border border-dashed border-[#172113]/22 bg-[#f7f8ef] p-3 shadow-[0_12px_34px_rgba(31,43,18,0.08)] transition-all duration-300 hover:border-[#183b16]/30 hover:shadow-[0_16px_42px_rgba(24,59,22,0.08)] dark:border-[#d5e6a9]/20 dark:bg-[#11160e] dark:shadow-[0_16px_38px_rgba(0,0,0,0.42)] dark:hover:border-[#b8ff5c]/30"
            >
        ...
        <div className="relative mx-auto flex w-full max-w-xs items-center justify-center">
          ...
          >
            <div className="overflow-hidden rounded-[20px] border border-dashed border-[#172113]/22 bg-[#f7f8ef] p-3 shadow-[0_12px_34px_rgba(31,43,18,0.10)] dark:border-[#d5e6a9]/20 dark:bg-[#11160e] dark:shadow-[0_16px_38px_rgba(0,0,0,0.42)]">
              <Image
            ...
            <m.div 
              ...
              className="absolute -bottom-3 -right-3 flex h-12 w-20 items-end justify-center gap-1 rounded-[20px] border border-dashed border-[#172113]/22 bg-[#fbfcf2] px-3 py-2.5 shadow-[0_12px_34px_rgba(31,43,18,0.10)] dark:border-[#d5e6a9]/20 dark:bg-[#11160e] dark:shadow-[0_16px_38px_rgba(0,0,0,0.42)]"
            >
