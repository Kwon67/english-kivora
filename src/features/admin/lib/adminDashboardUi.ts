...
export const adminDashboardHero = `${landingHeroCardClass} admin-hero-shadow relative overflow-hidden rounded-[13px] sm:rounded-[20px]`
...
export const adminDashboardMetricStrip = `flex w-full min-w-0 flex-col gap-2.5 overflow-hidden md:flex-row md:items-center md:justify-between ${landingRadius} border border-brand-dark bg-brand-accent/40 px-4 py-3 md:gap-4`
...
export const adminDashboardActionTile = `group flex min-h-[56px] items-center justify-between ${landingRadius} border border-brand-dark bg-bg-card px-4 py-3.5 font-heading text-sm font-bold text-brand-dark transition hover:bg-brand-dark hover:text-white`

export const adminDashboardField = `w-full rounded-[13px] border border-brand-dark bg-bg-primary py-2.5 pl-11 pr-11 font-body text-sm font-semibold text-brand-dark outline-none transition focus:shadow-[0_0_0_3px_rgba(213,224,107,0.45)] [appearance:none] [-webkit-appearance:none]`

export const adminDashboardSpotlightCard = `${landingRadius} border border-brand-dark bg-bg-primary px-3 py-3 sm:px-4 sm:py-3.5`
...
export const adminSidebarShell =
  'flex w-full shrink-0 flex-col overflow-hidden rounded-[13px] border border-brand-dark bg-bg-card p-3 sm:p-4 lg:sticky lg:top-5 lg:max-h-[calc(100vh-2.5rem)] lg:max-h-[calc(100svh-2.5rem)] lg:w-[15.5rem] lg:overflow-y-auto'

export const adminSidebarHeader = 'border-b border-brand-dark/15 pb-4'

export const adminSidebarProfile = `rounded-[13px] border border-brand-dark/25 bg-bg-primary px-3 py-3`
