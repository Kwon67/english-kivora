...
export const adminMembersDangerAction = `inline-flex items-center gap-1.5 rounded-container border border-brand-dark bg-bg-card px-2.5 py-1.5 font-heading text-2xs font-bold uppercase tracking-widest text-brand-dark transition hover:border-red-500/40 hover:bg-red-500/10 hover:text-red-700 disabled:opacity-60`