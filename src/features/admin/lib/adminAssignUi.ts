...
export const adminAssignAccentPill = `inline-flex items-center rounded-full border border-brand-dark bg-brand-accent px-2.5 py-1 font-heading text-[10px] font-bold uppercase tracking-widest text-brand-dark`

export const adminAssignFieldLabel = 'font-heading text-[10px] font-bold uppercase tracking-widest text-brand-secondary'

export const adminAssignSectionDivider = 'border-b border-brand-dark/15'

export const adminAssignModeCardActive = `min-h-24 rounded-[13px] border border-brand-dark bg-brand-accent p-3 transition-colors`

export const adminAssignModeCardIdle = `min-h-24 rounded-[13px] border border-brand-dark/30 bg-bg-card p-3 transition-colors hover:border-brand-dark/50 hover:bg-bg-primary`

export const adminAssignWeekdayActive = `flex h-10 items-center justify-center rounded-[13px] border border-brand-dark bg-brand-accent font-heading text-xs font-semibold text-brand-dark transition-colors`
