...
const migrationPath = resolve(
  process.cwd(),
  'supabase/migrations/20260701120000_user_onboarding.sql'
)
...
if (process.env.DATABASE_URL) {
  ...
  if (result.status === 0) {
    console.log('Migration user_onboarding aplicada com sucesso via DATABASE_URL.')
    process.exit(0)
  }
...
console.log('  npx supabase link --project-ref <seu-project-ref>')
